...
urlpatterns = [
    ...
    url(r'^admin$',view_admin, name='view_admin'), #ver pagina de administrador controlador
    #path('admin_popup/<int:id_plancompleto>/',view_aprobar_flp, name='view_aprobar_flp'),
    path('admin_popup/<int:id_plancompleto>/',view_aprobar_flp, name='view_aprobar_flp'),
    url(r'^tablero$',view_tablero, name='view_tablero'), #ver pagina de administrador controlador
