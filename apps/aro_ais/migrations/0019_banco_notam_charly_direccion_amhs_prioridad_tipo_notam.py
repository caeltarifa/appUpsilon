...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('aro_ais', '0018_auto_20210323_0353'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serie_numero_charly', models.CharField(max_length=80)),
                ('serie_numero_alfa', models.CharField(max_length=80)),
                ('serie_numero_charly_repla', models.CharField(max_length=80)),
                ('serie_numero_alfa_repla', models.CharField(max_length=80)),
                ('serie_numero_charly_cancel', models.CharField(max_length=80)),
                ('serie_numero_alfa_cancel', models.CharField(max_length=80)),
